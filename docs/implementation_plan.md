...
- Task cells are selection-only on single click. Double-click opens the explicit Set/Unset/cancel editor so blur or accidental selection cannot create a resource override.
