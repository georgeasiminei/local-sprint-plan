...
- **Editable cells:** In resource allocation view, click any cell → inline plain-text numeric edit box. Setting a value creates a resource rule from that week onward; clearing the cell removes the rule for that week.
