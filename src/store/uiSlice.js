...
export function createUiSlice(set, get) {
  return {
    ...
    openResourceCellEditor: (taskId, weekIndex) => set({ editingResourceCell: { taskId, weekIndex } }),
    closeResourceCellEditor: () => set({ editingResourceCell: null }),
    ...
    showSettingsPanel: () => set({ activePanel: 'settings', isSidebarOpen: true, editingResourceCell: null }),
